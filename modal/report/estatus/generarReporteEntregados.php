<div class="modal fade" id="generarReporteEstatusEntregados" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-titlen text-dark mx-auto" id="title-head-modal">Generar Reporte de Estatus de  Entregados</h5>
            ...
            <div class="modal-body">
                <form action="redireccionamientoEstatus.php" method="POST">
                    ...
                    <hr>
                    <input type="hidden" name="estatus" value="7">
